...
/* package canowars-0.1.0.0 */
#ifndef VERSION_canowars
#define VERSION_canowars "0.1.0.0"
#endif /* VERSION_canowars */
#ifndef MIN_VERSION_canowars
#define MIN_VERSION_canowars(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_canowars */
...
#define CURRENT_COMPONENT_ID "canowars-0.1.0.0-inplace-canowars"
